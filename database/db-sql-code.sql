-- Creates the account_type enum
CREATE TYPE public.account_type AS ENUM
  ('Client', 'Employee', 'Admin');

-- Updates the account table to include the account_type
ALTER TYPE public.account_type
  OWNER TO badillo2780;
...
-- Updates the inventory table to include the classification_id
